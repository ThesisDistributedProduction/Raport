...
\begin{table}[ht]
\captionsetup{singlelinecheck=false,labelsep=newline,justification=centering,font=footnotesize,labelfont={bf,red},format=plain}
...
FAR & False Acceptance Rate \\
 MCYT &  MCYT biometric database\\[1ex] % [1ex] adds vertical space
