...
\setcounter{wavenum}{0}
	...
	\nextwave{Turbine} \timeSpanA \unknown{readStates}{2.5} \unknown{calculate}{2.5} \timeSpanLabel \unknown{setSetpoint}{2.5} \unknown{sendState}{2.5} \timeSpanB \known{sleep}{1.5}
	\nextwave{} \known{receiveStates}{11.5}
\end{tikzpicture}
}
