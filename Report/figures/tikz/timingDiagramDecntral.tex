...
\newcommand{\timeSpanB}{
	...
	\graph[use existing nodes]{
		t_timeSpanA --[time span=1cm] t_timeSpanB;
	}; 
}
...
% 	\nextwave{DataPooling} \known{ReciveData}{11}
% 	\nextwave{Regulation Time} \unknown{SendData}{2} \known{DataWaitTime}{7} \unknown{Calculate}{2} \known{Buffer}{2}

 	\nextwave{} \timeSpanA \unknown{Send SP}{3} \unknown{ReadData}{3} \timeSpanLabel  \unknown{Calculate}{3} \timeSpanB \known{Buffer}{5}
 	\nextwave{} \known{ReciveData}{14}
 	\end{tikzpicture}
}
