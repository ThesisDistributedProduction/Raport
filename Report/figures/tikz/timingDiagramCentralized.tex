...
\newcommand{\timeSpanLabel}{
	\node (CycleTimeLabel) [rectangle, above = 1.01cm of t_cur, inner sep=0pt] {CycleTime};	  
}
...
\begin{tikzpicture}[
  ...
  \nextwave{} \timeSpanA \unknown{ReqData}{3} \known{Wait}{3} \timeSpanLabel \unknown{ReadData}{2}  \unknown{Calculate}{2} \unknown{Send SP}{2} \timeSpanB
  
  \nextwave{} \known{Wait}{3} \unknown{SendData}{3} \known{Wait}{6} \unknown{Recive SP}{2}
