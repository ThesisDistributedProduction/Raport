...
\begin{tikzpicture}[
  ...
  \nextwave{} \timeSpanA \unknown{Request states}{2.7} \known{Wait for states}{2.8} \unknown{Read states}{2.3} \timeSpanLabel \unknown{Calculate}{2}\unknown{Send setpoints}{3} \known{Buffer}{1.7} \timeSpanB
