...
The experiments are performed using up to 3 machines connected using a 1Gbit ethernet router with IGMP support.
The experiments are run on 3 laptops, with one being used to capture test data and the other 2 optionally running a number of turbines to generate network traffic.
...
\subsection{Cycle time and the impact on cache read count}
...
\subsection{Number of turbines and their impact on regulation time and cache count}
