...
%The increase in power regulation time is primarily caused by acquiring states of each turbine, since acquiring states involves . This  the fact that the park regulator must request a state from an extra turbine and wait for the turbine to provide the state.
