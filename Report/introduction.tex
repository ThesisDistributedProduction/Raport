...
The aim is to investigate and choose components, such that the best configuration is achieved with respect to distribution of data and computation across a production environment like the Siemens case. 
