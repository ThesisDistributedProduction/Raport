...
\renewcommand\chaptitlefont{\color{black}\Huge\usefont{OT1}{phv}{bc}{n}\selectfont\raggedright}
%\setsubsecheadstyle{\color{MyDarkBlue}\large\bfseries\sffamily\raggedright}
\setsubsecheadstyle{\color{black}\large\bfseries\sffamily\raggedright}
%\setsubsubsecheadstyle{\color{webred}\Huge\usefont{OT1}{phv}{bc}{n}\selectfont\raggedright}
\setsubsubsecheadstyle{\color{black}\Huge\usefont{OT1}{phv}{bc}{n}\selectfont\raggedright}
...
{\color{black}\usefont{OT1}{phv}{b}{n}\selectfont}{\thesubsection}{1em}{}
...
\titlespacing{\subsection}{15pt}{15pt}{10pt}
...
\def\section@cntformat{\color{black}\protect\makebox[0pt][r]{\thesection.\quad}}
\makeatother
...
\include{DistributedComputing}
\include{PrototypeDevelopment}
\include{Comparison}
\include{Conclusion}
%\include{chapter1}
%\include{chapter2}
