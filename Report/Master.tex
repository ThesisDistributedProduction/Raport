...
% sÃ¸g for at hvis en \section el.lign. flyttes til en ny side
% da skal siden fÃ¸r ikke strÃ¦kkes
...
\usepackage{makeidx}
\usepackage{mflogo} 
\makeindex % hvis man anvender sÃ¥dan en
...
\newcommand{\buildBoxPlot}[6][blue!60]{
	\addplot+[
	#1,
	solid,
	boxplot prepared={
