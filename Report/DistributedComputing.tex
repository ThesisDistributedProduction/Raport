...
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth,natwidth=610,natheight=642]{DistributedSharedMemory.png} 
...
\begin{figure}[b]
	\centering
	\includegraphics[width=0.9\textwidth,natwidth=610,natheight=642]{PublishSubscribe.png} 
	\captionsetup{format=plain,font=footnotesize,labelfont={bf,defaultCapFont},labelsep=quad,singlelinecheck=no}
	\caption[Distributed Computing System with 2 nodes]{
...
\begin{figure}[!h]
	...
	\caption[JMS overview]{
		...
		\footnotesize{%
			CORBA overview~\cite{corbaOverview}.
		}
	}
\end{figure}
...
\begin{figure}[!h]
	...
	\caption[JMS overview]{
		...
		\footnotesize{%
			AMQP overview~\cite{amqpOverview}.
		}
	}
\end{figure}
...
\label{sec:DDS}
The DDS standard provides a number of services relevant to a decentralized solution like the one this thesis aims to create:
