...
To perform the regulation sequence as fast as possible, the best solution, in theory, is to keep all data from all turbines locally available to each turbine, so each turbine can perform the regulation sequence themselves, without accessing the hard disk. 
