...
%Only built for testing purposes

\section{Regulation algorithm}\label{sec:regAlgorithm}

\section{Communication}\label{sec:currentSystemCen} 

The first area studied when building the centralized solution, was the communication around the regulation algorithm and what data is needed for the algorithm to calculate setpoints for every turbine. This section explains how the communication around the centralized solution is built.
...
%		\begin{call}{parkPilot}{calculateAllSetpoints()}{parkPilot}{}
%		\end{call}
%	
%		\begin{sdblock}{each turbine}{}
%			\mess[1]{parkPilot}{setNewSetpoint}{turbine}
%		\end{sdblock}
...
A simple overview of the first part of the regulation sequence is presented on \cref{fig:getStatesOfTurbines}. This part of the algorithm is implemented using the RTI DDS Request-Reply implementation~\cite{rtiConnextUsersManual}. The three objects presented are:
...
Next the setpoint for every turbine is calculated.
