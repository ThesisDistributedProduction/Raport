...
To answer the \ref{PS:Q:Feasibility} question we have the following fundamental needs of the Siemens case, currently provided by the Wind Park Supervisor and the Park Pilots:
...
Question \ref{PS:Q:Availability} and \ref{PS:Q:Performance} of the problem statement are addressed by all of the chapters above.
