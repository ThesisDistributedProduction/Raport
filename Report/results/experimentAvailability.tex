...
There are some instability around the time when the turbines are killed, however this settles outside the screen shots.\todo{It would be nice with something to back this up with.}
