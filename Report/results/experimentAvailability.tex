...
There are some instability around the time when the turbines are killed, however this settles outside the screen shots.\todo{It woudl be nice with something to back this up with.}
