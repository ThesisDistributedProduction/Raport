...
%\paragraph{Job scheduling strategies} %DNS Datacenter Application
...
\begin{description}
\item[NGINX] is a application level load balancer with a built in high performance\todo{ref} web server, it does can inspect http headers and use the information within to distribute traffic to servers groups.
