...
With multiple turbines able run serve requests and no quarantine that all turbines are online, How do they know witch turbine to connect to?
...
\paragraph{Abstraction levels} %DNS Datacenter Application
...
There also exists load balancers witch are integrated in every client and server, these are however not and option since clients are not always possible to modify.
